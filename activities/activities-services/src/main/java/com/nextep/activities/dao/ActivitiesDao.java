...
public interface ActivitiesDao extends CalDaoExt<Activity> {
	 ...
	 */
	List<Activity> getActivitiesCreatedByUser(ItemKey userKey,
	 ...
	 */
	int getTypedActivitiesForCount(ItemKey itemKey,
	 ...
	 */
	int getActivitiesCreatedByUserCount(ItemKey itemKey,
	 ...
	 */
	List<Activity> getTypedActivitiesFor(ItemKey itemKey,
