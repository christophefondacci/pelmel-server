...
public class PopularPlacesSupportImpl implements PopularSupport {
	private static final String TRANSLATION_KEY_TITLE = "block.popular.places.title";
	...
	public String getUrl(CalmObject element) {
		return urlService.getPlaceOverviewUrl("mainContent", element);
	}

	@Override
	public String getIconUrl(CalmObject element) {
		return messageSource.getMessage(
				KEY_ICON_PREFIX + ((Place) element).getPlaceType(), null,
				locale);
	}
