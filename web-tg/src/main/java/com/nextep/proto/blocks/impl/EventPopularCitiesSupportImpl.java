...
public class EventPopularCitiesSupportImpl implements PopularSupport {

	// private static final Log LOGGER = LogFactory
	// .getLog(EventPopularCitiesSupportImpl.class);
	private static final String TRANSLATION_KEY_TITLE = "block.popular.citiesEvent.title";
